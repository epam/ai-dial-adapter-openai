...
1. [Background mode](https://developers.openai.com/api/docs/guides/background/) isn't supported since it requires `GET /responses/{response_id}` that isn't supported yet.
