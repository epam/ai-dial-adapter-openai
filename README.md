...
|SSE_HEARTBEAT_INTERVAL||If set, the adapter inserts periodic ping comments into streaming chat completion responses to prevent read timeouts when the upstream is idle for a long time.|
